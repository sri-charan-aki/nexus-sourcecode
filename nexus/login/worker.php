...
if(isset($_POST['worker-submit'])){
  ...
  if($age<18||$age>60){
      $ageerr1="we are  not takinng people under 18 years age and above 60 years age";
  }
  if(!preg_match("/[0-9]{10}/",$phone)){
      $phoneerr1="invalid phone number";
  }
  if($nameerr1==""&&$ageerr1==""&&$phoneerr1==""){
    ...
    $user_update = "update workers set name='$name', age='$age', gender='$gender', phone_number='$phone', address='$address', email='$email' where user_name='$username' ";
  ...
  <body>
    <div class="one-third col-md-4">
      ...
      <form id="edit-details" action="contractor.php?user_name=<?php echo $username;?>" method="post" style="display: none;">
        ...
        <input type='submit' name='worker-submit' class="btn btn-outline-dark" value='submit'><br>
      </form>
      </div>
      <div class="col-md-6">
        <h3>Mail Box</h3>
